...
const UserExtraData = ({ data }) => {
    return (
        <View>
            <Text>PI Number: {data.pi}</Text>
            <Text>Dated: {data.piDate.toString()}</Text>
            <Text>LC Number: {data.lc}</Text>
            <Text>Dated: {data.lcDate.toString()}</Text>
        </View>
    )
}
...
const BuyerEximData = ({ data }) => {
    return (
        <View>
            <Text>EXIM Code: {data.exim}</Text>
    ...
    <Document>
      <Page style={styles.container}>
        ...
        >
          <View>
            <UserData data={user} />
            <UserExtraData data={userExtraData} />
          </View>
        ...
        <AddressData data={userAddress} label="Address" marginBottom={0} />
        <ContactData data={userContact} />
        <AddressData
          data={buyerAddress}
          marginBottom={0}          
        />
        <BuyerEximData data={buyerExim} />
        <ContactData data={buyerContact} />
